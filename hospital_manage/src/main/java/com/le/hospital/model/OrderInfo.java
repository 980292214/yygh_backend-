...
public class OrderInfo extends BaseEntity {
	...
	@ApiModelProperty(value = "退号时间?")//和h_manage数据库表的 quitTime 意思一样吗？？
	@TableField("quit_time")
	private Date quitTime;//手动设置的

	@ApiModelProperty(value = "订单状态")
	@TableField("order_status")
	private Integer orderStatus;//0:预约成功，未支付; -1:取消订单 ; 1:支付成功 ; 2:已取号
