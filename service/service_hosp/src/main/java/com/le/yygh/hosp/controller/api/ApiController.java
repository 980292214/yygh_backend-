...
/**
 * 和医院系统 (hospital_manage) 对接的 Controller，处理发送过来的请求
 * 除了上传的，查询和删除的都没用上？？？2022.4.23
 */
@RestController
...
public class ApiController {
    ...
    public Result saveHosp(HttpServletRequest request) {
        //获取 hospital_manege 传递过来医院信息
        //是一个Map类型的值，该返回值记录着前端（如jsp页面）所提交请求中的请求参数和请求参数值的映射关系。
        ...
        //base64编码，传输过程中“+”转换为了“ ”，因此我们要转换回来，否则显示不正常
    ...
    private void checkSignKey(Map<String, Object> paramMap) {
        ...
        //3 把数据库查询签名进行MD5加密，用两个都经过加密的密文对比
